...
A python3.6+ toolbox with multi useful utils, functions, decorators in pythonic way, and is fully tested for python3.6 to python3.10 .
...
def main():
    ...
    try:
        ...
        p = subprocess.run(curl_cmd_str, shell=True, universal_newlines=True,
